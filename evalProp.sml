(*
     ...
     4. La función evalProp evalúa una proposición en el contexto de una asignación de valores 
     booleanos a las variables proposicionales2. 

     El contexto (o ambiente) permite determinar el valor de cada variable dentro de una proposición.
*)
